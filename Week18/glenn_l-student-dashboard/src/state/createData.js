import personData from "./Winc Eindopdracht – Studenten Mock data – Frontend Cursus Opdrachten.json";
...
const generateStudentInfo = (student) => {
    const studentInfo = {
        ...
        Email: generateMailAddress(student.Name, student.Lastname),
...
const uniqueStudents = [...new Map(
    personData.map(student => {
        const key = object => object.Name;
        return [key(student), student];
    })).values()];


const arrayOfStudentInfo = uniqueStudents.map(student => {
